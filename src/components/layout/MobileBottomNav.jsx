...
const NavIcon = ({ children, isActive, count }) => (
    <a href="#" className={`relative flex flex-col items-center justify-center w-full pt-2 text-gray-500 ${isActive ? 'text-blue-600' : ''}`}>
        {children}
        {count && (
            <span className="absolute top-0 right-4 px-1.5 py-0.5 text-xs font-semibold text-white bg-red-500 rounded-full">{count}</span>
        )}
    </a>
);
