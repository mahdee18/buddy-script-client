    ...
    return (
        <div className="p-6 mb-4 bg-white rounded-lg shadow">
            ...
            <div className="mb-4">
                ...
                {post.imageUrl && (
                    <img src={post.imageUrl} alt="Post content" className="w-full rounded-lg" />
                )}
            </div>
            ...
            <div className="flex items-center justify-between mb-4 text-sm text-gray-500">
                ...
                <div>
                    <span>{post.comments.length} Comments</span> &middot; <span>{post.shares} Shares</span>
                </div>
            </div>
            ...
            <div className="flex items-start mt-4 space-x-3">
                ...
                <div className="flex-1">
                    <textarea 
                        className="w-full p-2 text-sm bg-gray-100 border border-transparent rounded-lg focus:outline-none focus:bg-white focus:border-gray-300" 
                        rows="1" 
