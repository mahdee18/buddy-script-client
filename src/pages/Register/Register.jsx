        ...
        <div className="flex flex-wrap items-center -mx-4">
          ...
          <div className="w-full px-4 lg:w-1/3">
            <div className="px-6 py-12 bg-white rounded-lg shadow-lg md:px-12">
              ...
              <h4 className="mb-12 text-4xl font-bold text-gray-800">Registration</h4>
              ...
              <form>
                ...
                <div className="flex items-center mb-10">
                  <input type="radio" id="terms" name="terms" className="w-4 h-4 text-blue-600" defaultChecked />
