...
const Login = () => {
  ...
  return (
    <section className="relative min-h-screen bg-[#F3F5F9] flex items-center justify-center p-4 overflow-hidden">
      ...
      {/* Background Shapes Layer (z-index 0) */}
      ...
      {/* Main Content Wrapper (relative, z-index 10) */}
      <div className="container relative z-10 w-full max-w-6xl">
        <div className="grid items-center grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="w-full max-w-md mx-auto lg:mx-0 lg:max-w-none">
            <div className="px-6 py-10 bg-white  rounded-xl shadow shadow-dark-2xl md:px-10">
              <div className="mb-7"><img src={logo} alt="Buddy Script Logo" /></div>
              <p className="mb-2 text-gray-500 text-gray-400">Welcome back</p>
              <h4 className="mb-10 text-4xl font-bold text-gray-800 text-gray-200">Login to your account</h4>
              <button type="button" className="flex items-center justify-center w-full py-3 mb-8 font-semibold text-gray-600 text-gray-300 transition duration-300 bg-white  border border-gray-300 rounded-lg shadow shadow-dark-sm hover:bg-gray-50 hover:text-gray-800"><img src={googleIcon} alt="Google Icon" className="mr-3" /><span>Or sign-in with google</span></button>
              ...
              <form onSubmit={handleSubmit}>
                <div className="mb-4">
                  ...
                  <input type="email" name="email" value={credentials.email} onChange={handleChange} required className="w-full px-4 py-3 bg-white  border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-white" />
                </div>
                <div className="mb-4">
                  <label className="block mb-2 font-medium text-gray-700">Password</label>
                  <input type="password" name="password" value={credentials.password} onChange={handleChange} required className="w-full px-4 py-3 bg-white  border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-white" />
                </div>
                {error && <p className="mb-4 text-sm text-center text-red-600">{error}</p>}
                <div className="flex flex-wrap items-center justify-between mb-8">
                  <div className="flex items-center"><input type="radio" id="rememberMe" name="remember" className="w-4 h-4 text-blue-600" defaultChecked /><label htmlFor="rememberMe" className="ml-2 text-gray-600 text-gray-300">Remember me</label></div>
              ...
              <p className="text-center text-gray-600 text-gray-300">
